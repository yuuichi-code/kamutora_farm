class PostFormStep1
  ...
  attr_accessor :title, :training_character, :first_character, :second_character, :third_character, :fourth_character, :fifth_character, :sixth_character

  validates :title,               presence: true
  validates :training_character,  presence: true
  ...
  validate  :validate_training_character_uniqueness

  private

  # 修行仲間の選択が重複しているかをチェックする
  ...
  def validate_training_character_uniqueness
    ...
    errors.add(:training_character, I18n.t('defaults.same_training_characters')) if support_characters.include?(training_character)
  end
end
